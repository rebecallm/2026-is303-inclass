...
num_guests =int(input("How many number of guests? "))
food_cost = float(input("What is the cost per person for food? "))
drink_cost = float(input("What is the cost per person for drinks? "))
venue_cost = input("Do you need to rent a venue? yes or no ").lower()
if venue_cost == "yes": 
    venue_price = 250 
else: 
    venue_price = 0 
...
venue_total = venue_price
grand_total = (food_total + drink_total + venue_total)
